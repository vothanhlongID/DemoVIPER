...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    // set default value for application
    [self initializeData];
    [self setUpRootView];
    return YES;
}
...
- (void)setUpRootView {
    ...
    LoginRouting *routing = [[LoginRouting alloc] init];
    loginViewController.eventHandler = presenter;
    presenter.interactorInput = interactor;
    interactor.interactorOutput = presenter;
    presenter.routing = routing;
    routing.loginViewController = loginViewController;
